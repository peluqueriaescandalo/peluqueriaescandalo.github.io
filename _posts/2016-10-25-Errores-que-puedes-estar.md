...
---
 ...
 <div>
   ...
   <h3>Error 1. Tener el pelo demasiado mojado cuando empiezas a secarlo</h3>
   <p>
   ...
   <h3> Error 2. No darte un producto que prepare tu pelo para el secado</h3>
   <p>
   ...
   <h3> Error 3. No estar usando el producto correcto para tu tipo de pelo</h3>
   <p>
   ...
   <h3> Error 4. Usar un peine que no es apropiado</h3>
   <p>
   ...
   <h3> Error 5. Estar usando una temperatura incorrecta</h3>
   <p>
  ...
  <h3> Error 6. Haber hecho mal las particiones del pelo</h3>
  <p>
  ...
  <h3> Error 7. No estar secando el pelo en al dirección correcta.</h3>
  <p>
  ...
  <h3> Error 8. No usar la boquilla del secador.</h3>
  <p>
