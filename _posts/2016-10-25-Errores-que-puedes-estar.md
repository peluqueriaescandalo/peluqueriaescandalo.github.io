...
---
 ...
 <article class="container mod-row">
  <div class="container-item-text-left">
   <p>
    Queremos compartir contigo algunos trucos para obtener un mejor resultado secandote el pelo y sobretodo para ayudarte a no dañarlo.
   </p>
 </div>
 <div>
    <img src="img/secarse-el-pelo.jpg" width="310" height="auto" alt="Errores cuando te secas el pelo">
 </div>
   <h3>E1. Tener el pelo demasiado mojado cuando empiezas a secarlo</h3>
   <p>
